;*****************************************************************************
;* Williams Level 7 Defined - PERC - Pinball Executive Resource Control
;*****************************************************************************
;* Interpretation by Jess M. Askey (jess@askey.org)
;* For use with TASMx Assembler
;* Visit http://gamearchive.askey.org/pinball/manufacturer/williams/pinbuilder
;* for more information.
;*****************************************************************************

;*****************************************************************************
;* This is where you should put general timesaving macros above and beyond
;* the base logic and PERC macros...
;*
