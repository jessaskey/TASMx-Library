...
;* Jess M. Askey 2001 jess@askey.org*
;***********************************************
.module logic
.msfirst
...
#define	ifge	logic_ifxx(BLS)
#define	ifgt	logic_ifxx(BLE)
#define	iflt 	logic_ifxx(BGE)
#define	ifle	logic_ifxx(BGT)
#define	ifgte	logic_ifxx(BLT)
...
#define	geend	logic_loopend(BLS,BLT)
#define	leend	logic_loopend(BGT,BLE)
